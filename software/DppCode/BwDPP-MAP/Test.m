%% The C = SeDppMap(A, gamma) implements the BwDPP-MAP in the paper
%% A: the almost block diagonal kernel
%% gamma: the level for gamma-partition
%% C: the MAP inference result, the subset of points selected by the BwDPP-MAP infernece.
